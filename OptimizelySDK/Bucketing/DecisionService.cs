    ...
    public class DecisionService
    {
        ...
        )
        {
            ...
            var doesUserMeetAudienceConditionsResult =
                ExperimentUtils.DoesUserMeetAudienceConditions(config, experiment, filteredAttributes,
        ...
        )
        {
            ...
            while (index < rolloutRulesLength)
            {
                ...
                var doesUserMeetAudienceConditionsResult =
                    ExperimentUtils.DoesUserMeetAudienceConditions(config, rule, attributes,
