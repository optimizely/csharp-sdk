...
namespace OptimizelySDK.XUnitTests
{
    public class DecisionServiceTest
    {
        ...
        public void TestGetVariationForcedVariationPrecedesAudienceEval()
        {
            ...
            Assert.Null(decisionService.GetVariation(experiment, GenericUserId, ProjectConfig, new UserAttributes()));
            ...
            Assert.True(TestData.CompareObjects(actualVariation, expectedVariation));
        ...
        public void TestGetForcedVariationReturnsForcedVariation()
        {
            ...
            Assert.True(TestData.CompareObjects(WhitelistedVariation, decisionService.GetWhitelistedVariation(WhitelistedExperiment, WhitelistedUserId)));
        ...
        public void TestGetForcedVariationWithInvalidVariation()
        {
            ...
            Assert.Null(decisionService.GetWhitelistedVariation(experiment, userId));
        ...
        public void TestGetForcedVariationReturnsNullWhenUserIsNotWhitelisted()
        {
            ...
            Assert.Null(decisionService.GetWhitelistedVariation(WhitelistedExperiment, GenericUserId));
        }
        ...
        public void TestBucketReturnsVariationStoredInUserProfile()
        {
            ...
            Assert.True(TestData.CompareObjects(variation, decisionService.GetVariation(experiment, UserProfileId, ProjectConfig, new UserAttributes())));
        ...
        public void TestGetStoredVariationLogsWhenLookupReturnsNull()
        {
            ...
            Assert.Null(decisionService.GetStoredVariation(experiment, userProfile, ProjectConfig));
        ...
        public void TestGetStoredVariationReturnsNullWhenVariationIsNoLongerInConfig()
        {
            ...
            Assert.Null(decisionService.GetStoredVariation(experiment, storedUserProfile, ProjectConfig));
        ...
        public void TestGetVariationUserWithSetForcedVariation()
        {
            ...
            Assert.True(TestData.CompareObjects(VariationWithKeyControl, actualVariation));

            // test valid experiment
            Assert.True(optlyObject.SetForcedVariation(experimentKey, userId, expectedForcedVariationKey), string.Format(@"Set variation to ""{0}"" failed.", expectedForcedVariationKey));
            ...
            Assert.True(optlyObject.SetForcedVariation(experimentKey, userId, null));

            actualVariation = optlyObject.GetVariation(experimentKey, userId, userAttributes);
            Assert.True(TestData.CompareObjects(VariationWithKeyControl, actualVariation));

            // check that a paused experiment returns null
            Assert.True(optlyObject.SetForcedVariation(pausedExperimentKey, userId, expectedForcedVariationKey), string.Format(@"Set variation to ""{0}"" failed.", expectedForcedVariationKey));
        ...
        public void TestGetVariationWithBucketingId()
        {
            ...
            Assert.True(TestData.CompareObjects(VariationWithKeyVariation, actualVariation));
            ...
            Assert.True(optlyObject.SetForcedVariation(experimentKey, userId, variationKeyControl), string.Format("Set variation to \"{0}\" failed.", variationKeyControl));
            actualVariation = optlyObject.GetVariation(experimentKey, userId, userAttributesWithBucketingId);
            Assert.True(TestData.CompareObjects(VariationWithKeyControl, actualVariation));
            ...
            actualVariation = optlyObject.GetVariation(experimentKey, userId, userAttributesWithBucketingId);
            Assert.True(TestData.CompareObjects(VariationWithKeyControl, actualVariation), string.Format("Variation \"{0}\" does not match expected user profile variation \"{1}\".", actualVariation?.Key, variationKeyControl));
        }
        ...
        public void TestGetVariationForFeatureExperimentGivenNonMutexGroupAndUserIsBucketed()
        {
            ...
            Assert.True(TestData.CompareObjects(expectedDecision, decision));
        ...
        public void TestGetVariationForFeatureRolloutWhenNoRuleInRollouts()
        {
            ...
            Assert.Equal(0, rollout.Experiments.Count);
        ...
        public void TestGetVariationForFeatureWhenTheUserIsBuckedtedInBothExperimentAndRollout()
        {
            ...
            Assert.True(TestData.CompareObjects(expectedRolloutDecision, actualRolloutDecision));
        ...
        public void TestSetGetForcedVariation()
        {
            ...
            Assert.Equal(expectedVariationKey, actualForcedVariation.Key);
            ...
            Assert.Equal(expectedVariationKey2, actualForcedVariation2.Key);
        ...
        public void TestSetForcedVariationMultipleSets()
        {
            ...
            Assert.Equal("variation", DecisionService.GetForcedVariation("test_experiment", "test_user_1", Config).Key);
            ...
            Assert.Equal("control", DecisionService.GetForcedVariation("test_experiment", "test_user_1", Config).Key);
            ...
            Assert.Equal("group_exp_1_var_1", DecisionService.GetForcedVariation("group_experiment_1", "test_user_1", Config).Key);

            // different user
            Assert.True(DecisionService.SetForcedVariation("test_experiment", "test_user_2", "variation", Config));
            Assert.Equal("variation", DecisionService.GetForcedVariation("test_experiment", "test_user_2", Config).Key);
            ...
            Assert.Equal("group_exp_1_var_1", DecisionService.GetForcedVariation("group_experiment_1", "test_user_2", Config).Key);
