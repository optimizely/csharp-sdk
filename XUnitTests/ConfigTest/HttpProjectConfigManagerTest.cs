...
namespace OptimizelySDK.XUnitTests.DatafileManagement_Tests
{
    public class HttpProjectConfigManagerTest
    {
        ...
        public HttpProjectConfigManagerTest()
        {
        ...
        public void TestHttpClientHandler()
        {
            ...
            Assert.True(httpConfigHandler.AutomaticDecompression == (System.Net.DecompressionMethods.Deflate | System.Net.DecompressionMethods.GZip));
        }
        ...
        public void TestOnReadyPromiseResolvedImmediatelyWhenDatafileIsProvided()
        {
            ...
            Assert.Equal("15", httpManager.GetConfig().Revision);
            ...
            t.Wait();
            Task.Delay(200).Wait();
            Assert.Equal("42", httpManager.GetConfig().Revision);
            httpManager.Dispose();
        }
        ...
        [Fact]
        public void TestHttpConfigManagerDoesNotWaitForTheConfigWhenDeferTrue()
        {
        ...
        public void TestDefaultBlockingTimeoutWhileProvidingZero()
        {
            ...
            Assert.NotEqual(expectedBlockingTimeout.TotalSeconds, TimeSpan.Zero.TotalSeconds);
        ...
        public void TestDefaultPeriodWhileProvidingZero()
        {
            ...
            Assert.NotEqual(expectedPollingInterval.TotalSeconds, TimeSpan.Zero.TotalSeconds);
