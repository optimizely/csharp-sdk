...
namespace OptimizelySDK.Tests
{
    ...
    public class OptimizelyUserContextTest
    {
        ...
        //[Test]
        //public void TestSetForcedDecisionIsCalledTwiceWithMultipleFlagKeys()
        //{
        //    var datafile = "";
        //    using (System.IO.StreamReader reader = new System.IO.StreamReader(@"C:\Users\Dustin\dev\csharp\csharp-sdk\datafiles\flags_with_rollouts.json"))
        //        datafile = reader.ReadToEnd();

        //    var expected = new Dictionary<string, OptimizelyDecision>
        //    {
        //        { "flag_1", new OptimizelyDecision("variation_1", true, null, null, "flag_1", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
        //        { "flag_2", new OptimizelyDecision("variation_2", true, null, null, "flag_2", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
        //        { "flag_3", new OptimizelyDecision(null, true, null, "flag_3_targeted_delivery", "flag_3", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
        //        { "flag_4", new OptimizelyDecision(null, true, null, "experiment_flag_4", "flag_4", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
        //    };
        ...
        //    var context = new OptimizelyDecisionContext("flag_1");
        //    var decision = new OptimizelyForcedDecision("variation_1");

        //    var context2 = new OptimizelyDecisionContext("flag_2");
        //    var decision2 = new OptimizelyForcedDecision("variation_2");
        ...
        //    Assertions.AreEquivalent(expected, result);
        //}
        ...
        public void TestSetForcedDecisionIsCalledTwiceWithMultipleFlagKeys()
        {
            ...
            var expected = new Dictionary<string, OptimizelyDecision>
            {
                { "flag_1", new OptimizelyDecision("exp_variation_1", true, optimizelyJSONUsingMap, null, "flag_1", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_2", new OptimizelyDecision("exp_variation_2", true, optimizelyJSONUsingMap, null, "flag_2", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_3", new OptimizelyDecision("variation_1", true, null, "flag_3_targeted_delivery", "flag_3", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_4", new OptimizelyDecision("exp_variation_1", true, null, "experiment_flag_4", "flag_4", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
            };
        ...
        [Test]
        public void TestRemoveForcedDecisionsCalledBeforeDecideAll()
        {
            var datafile = "";
            using (System.IO.StreamReader reader = new System.IO.StreamReader(@"C:\Users\Dustin\dev\csharp\csharp-sdk\datafiles\flags_with_rollouts.json"))
                datafile = reader.ReadToEnd();
            ...
            var expected = new Dictionary<string, OptimizelyDecision>
            {
                { "flag_1", new OptimizelyDecision("variation_1", true, null, "experiment_1_flag_1", "flag_1", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_2", new OptimizelyDecision("variation_2", true, null, null, "flag_2", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_3", new OptimizelyDecision("variation_1", true, null, "flag_3_targeted_delivery", "flag_3", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_4", new OptimizelyDecision("exp_variation_1", true, null, "experiment_flag_4", "flag_4", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
            };
            ...
            var remove = user.RemoveForcedDecision(context);

            Assert.IsTrue(remove);

            var actual = user.DecideAll();
        ...
        public void TestSetForcedDecisionisCalledTwiceWithMultipleFlagKeys()
        {
            ...
            var actual = user.DecideForKeys(new string[] { "flag_1", "flag_2" });

            Assertions.AreEquivalent(expected, actual);
        }

        [Test]
        public void TestRemoveForcedDecisionsCalledBeforeDecide()
        {
            var datafile = "";
            using (System.IO.StreamReader reader = new System.IO.StreamReader(@"C:\Users\Dustin\dev\csharp\csharp-sdk\datafiles\flags_with_rollouts.json"))
                datafile = reader.ReadToEnd();
            ...
            var expected = new Dictionary<string, OptimizelyDecision>
            {
                { "flag_1", new OptimizelyDecision("exp_variation_1", true, null, "experiment_1_flag_1", "flag_1", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_2", new OptimizelyDecision("variation_2", true, null, null, "flag_2", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
            };
        ...
        [Test]
        public void TestRemoveAllForcedDecisionsBeforeDecideAll()
        {
            var datafile = "";
            using (System.IO.StreamReader reader = new System.IO.StreamReader(@"C:\Users\Dustin\dev\csharp\csharp-sdk\datafiles\flags_with_rollouts.json"))
                datafile = reader.ReadToEnd();
            ...
            {
                { "flag_1", new OptimizelyDecision("exp_variation_1", true, null, "experiment_1_flag_1", "flag_1", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_2", new OptimizelyDecision("exp_variation_1", true, null, "experiment_1_flag_2", "flag_2", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_3", new OptimizelyDecision("variation_1", true, null, "flag_3_targeted_delivery", "flag_3", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
                { "flag_4", new OptimizelyDecision("exp_variation_1", true, null, "experiment_flag_4", "flag_4", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
            };
            ...
            var remove = user.RemoveAllForcedDecisions();
        ...
        [Test]
        public void TestEvaluateDecideAfterCallingSetForcedDecision()
        {
            var datafile = "";
            using (System.IO.StreamReader reader = new System.IO.StreamReader(@"C:\Users\Dustin\dev\csharp\csharp-sdk\datafiles\flags_with_rollouts.json"))
                datafile = reader.ReadToEnd();

            var decision1 = new OptimizelyDecision("exp_variation_1", true, null, "experiment_1_flag_1", "flag_1", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]);
            var decision2 = new OptimizelyDecision("exp_variation_1", true, null, "experiment_1_flag_1", "flag_1", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[] { "Variation (variation_1) is mapped to flag (flag_1) and user (test_user_1) in the forced decision map." });

            Optimizely = new Optimizely(datafile, EventDispatcherMock.Object, LoggerMock.Object, ErrorHandlerMock.Object);

            var user = Optimizely.CreateUserContext("test_user_1");

            var result1 = user.Decide("flag_1");

            Assertions.AreEqual(decision1, result1);

            var context = new OptimizelyDecisionContext("flag_1");
            var forcedDecision = new OptimizelyForcedDecision("variation_1");

            var forcedDecisionSet = user.SetForcedDecision(context, forcedDecision);

            Assert.IsTrue(forcedDecisionSet);

            var result2 = user.Decide("flag_1");

            Assertions.AreEqual(decision2, result2);
        }
    }
}
