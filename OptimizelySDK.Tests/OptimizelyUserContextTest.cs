    ...
    public class OptimizelyUserContextTest
    {
        ...
        public void TestRemoveForcedDecisionsCalledBeforeDecideAll()
        {
            ...
            var expected = new Dictionary<string, OptimizelyDecision>
            {
                ...
                { "flag_2", new OptimizelyDecision("exp_variation_2", true, null, null, "flag_2", new OptimizelyUserContext(Optimizely, "test_user_1", new UserAttributes(), ErrorHandlerMock.Object, LoggerMock.Object), new string[0]) },
